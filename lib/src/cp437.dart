...
const Map<int, int> _wideCharToUtf8 = {
  128: 199,
  129: 252,
  130: 233,
  131: 226,
...
class Cp437Codec extends Encoding {
  ...
  Cp437Decoder get decoder =>
      _allowInvalid ? const Cp437Decoder(true) : const Cp437Decoder();
}
...
class Cp437Encoder extends Converter<String, List<int>> {
  ...
  List<int> convert(String input) =>
      input.codeUnits.map((e) => e > 0x7f ? _utf8ToWide[e] ?? 63 : e).toList();
}
...
class Cp437Decoder extends Converter<List<int>, String> {
  ...
  @override
  String convert(List<int> input) => String.fromCharCodes(
      input.map((e) => e > 0x7f ? (_wideCharToUtf8[e] ?? 63) : e));
}
